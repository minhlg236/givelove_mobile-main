...
import useSponsorInCampaign from "./hooks/useSponsorInCampaign";
const Member = ({ route }: any) => {
  ...
  const { data } = useSponsorInCampaign(campaignId.toString());
  ...
  return (
    <View>
      ...
      >
        ...
        >
          <Text style={styles.title}>Thêm mạnh thường quân</Text>
          <AntDesign
          ...
          <View style={styles.searchContainer}>
            <TextInput
              placeholder="Nhập tên mạnh thường quân"
